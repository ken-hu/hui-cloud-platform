...
public class MybatisPlusCodeGen {
     ...
     * 子module路径
     */
    private static String CHILD_MODULE_PATH;
    ...
    public static void main(String[] args) {
        ...
        CHILD_MODULE_PATH = scanner(String.format("tip: %s/xxx (输出文件夹的相对路径,没有二级目录请填NULL)", projectPath), false);
        if (null == CHILD_MODULE_PATH) {
            FILE_OUTPUT_DIR = "";
        }
        if (!CHILD_MODULE_PATH.startsWith("/") || !CHILD_MODULE_PATH.startsWith("\\")) {
            FILE_OUTPUT_DIR = File.separator + CHILD_MODULE_PATH;
        }
